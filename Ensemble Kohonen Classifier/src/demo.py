...
from models.utils.utils import make_test_images, ImageTransformationsParams
...
def demo(train_images, class_names, test_classification=True):
    ...
    if test_classification:
        ...
        transformations_params = ImageTransformationsParams(transformations_dict)
        generated_test_images, true_labels = make_test_images(train_images, transformations_params, with_labels=True)
        current_labels = []
